...
/***************** TEMP *********************/
#define TEMP_INITIAL_CONFIG         0b11110000										  //Initial configuration of the TEMP sensor. Enabled, 0.5Hz.
#define TEMP_DEBUG                  1												  //Enables TEMP RTT debug


/***************** PR *********************/
#define PR_INITIAL_CONFIG           0b11110000										  //Initial configuration of the PR sensor. Enabled, 0.5Hz.
#define PR_DEBUG                    1												  //Enables PR RTT debug


/***************** HUM *********************/
#define HUM_INITIAL_CONFIG          0b11110000										  //Initial configuration of the HUM sensor. Enabled, 0.5Hz.
...
/***************** SD2APP *********************/
#define SD_INITIAL_CONFIG           0b11110001										  //Initial configuration of the PR sensor. Enabled, 0.5Hz.
#define SD_DEBUG                    1												  //Enables SD RTT debug


/***************** SD2APP_FLAG *********************/
#define SD_FLAG_INITIAL_CONFIG           0b11110000										  //Initial configuration of the PR sensor. Enabled, 0.5Hz.
#define SD_FLAG_DEBUG                    1												  //Enables SD_FLAG RTT debug
